...
document.addEventListener("DOMContentLoaded", () => {
    ...
    <a href="index.html" class="logo">Rentussy</a>
        <div class="navbar">
        <svg id="darkThemeToggle" width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        </svg>
